...
* personal computer or server with 64-bit GNU/Linux operating system
	...
	```
	$ uname -a
	# The expected output sequentially should be your kernel name, localhost name, kernel release, kernel version, machine hardware name (ex. x86_64 or x86_32), processor type (ex. x86_64 or x86_32), hardware platform (ex. x86_64 or x86_32) and operating system name
	```
