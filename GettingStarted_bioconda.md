...
```
During install the Miniconda, follow the End-User License Agreement (EULA) and its instruction. While the installation is completed, __restart the terminal__. 
